...
const Hero1 = () => {
  ...
  return (
    <section className="w-full text-[#282828] bg-white px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 py-12 sm:py-16 md:py-18 flex items-center">
      <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-20">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          {/* Mobile/tablet hero image — fluid aspect ratio instead of fixed height */}
          <img
            src="https://images.unsplash.com/photo-1629909613654-28e377c37b09?q=80&w=800&auto=format&fit=crop"
            alt="Modern clinic reception area"
            className="w-full max-w-md aspect-[4/3] sm:aspect-[16/10] rounded-2xl object-cover mb-8 lg:hidden shadow-lg shadow-neutral-900/10"
          />

          <h1 className="font-bold text-neutral-900 text-3xl sm:text-4xl md:text-5xl xl:text-6xl leading-[1.1] tracking-tight">
          ...
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-x-6 gap-y-2 mt-10 text-neutral-500 text-sm">
            <div>
              <span className="text-neutral-900 font-semibold text-lg">50k+</span>{" "}
              patients served
            </div>
            <div className="hidden xs:block h-4 w-px bg-neutral-200" />
            <div>
        ...
        <div className="hidden lg:flex w-full lg:w-1/2 justify-center lg:justify-end">
          <div className="relative w-full max-w-sm md:max-w-lg xl:max-w-xl">
            <div className="relative w-full h-[380px] md:h-[440px] xl:h-[520px] overflow-hidden rounded-3xl shadow-2xl shadow-neutral-900/20 ring-1 ring-black/5">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 xl:p-8">
                <h3 className="font-poppins text-xl md:text-2xl xl:text-3xl font-bold mb-2 text-white drop-shadow-sm">
