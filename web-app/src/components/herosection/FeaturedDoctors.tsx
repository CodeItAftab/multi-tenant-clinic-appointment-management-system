...
function FeaturedDoctors() {
    ...
    return (
        <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-15  lg:px-10">
            ...
            {/* Doctors Grid */}
            <div className="mt-12 grid grid-cols-2 gap-5 sm:grid-cols-2 md:grid-cols-4">
                        ...
                        <div className="relative p-5">
                            ...
                            <div className="mt-4 flex flex-col items-center text-center">
                                ...
                                <div className="mt-5 flex w-full flex-col gap-2">
                                    <Link
                                        href="/booking"
                                        className="group inline-flex items-center justify-center gap-2 rounded-xl bg-[#4bb1c8] py-2.5 text-[12px] font-bold text-white shadow-md shadow-[#e0f7fa] transition-all hover:bg-[#33b6d3] hover:shadow-lg hover:shadow-[#b2ebf2]"
                                    >
