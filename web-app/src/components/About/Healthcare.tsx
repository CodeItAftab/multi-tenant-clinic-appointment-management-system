...
function Healthcare() {
  return (
    <div className="w-full bg-white">
      <section className="relative overflow-hidden bg-gradient-to-br from-[#e0f7fa] via-white to-slate-50">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 text-center sm:px-6 sm:py-12 lg:px-10">
          <h1 className="mx-auto mt-6 max-w-3xl text-[30px] font-bold leading-tight tracking-tight text-slate-900 sm:text-[46px] lg:text-[54px]">
            Healthcare booking,{" "}
            <span className="text-[#4bb1c8]">built on transparency</span>.
          </h1>

          <p className="mx-auto mt-5 max-w-2xl text-[14px] leading-relaxed text-slate-600 sm:text-[16px]">
            Compassionate healthcare, trusted specialists, and personalized care
