...
import { insurancePartners } from "../../utils/servicesData";

function InsuranceSection() {
  return (
    <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-16 lg:px-10">
      <div className="text-center">
        <p className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.18em] text-[#4bb1c8]">
          <BadgeCheck size={16} className="text-[#4bb1c8]" />
          Cashless Insurance
        </p>
