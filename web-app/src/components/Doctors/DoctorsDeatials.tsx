...
function DoctorsDeatials() {
  ...
  return (
    <div className="bg-gradient-to-b from-white via-[#e0f7fa]/30 to-white">
      {/* Hero */}
      <section className="relative overflow-hidden border-b border-[#b2ebf2] bg-gradient-to-br from-[#e0f7fa] via-white to-white">
